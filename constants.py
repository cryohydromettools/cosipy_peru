...
LWin_method = 'Konzelmann94'                        # possitilities: 'Konzelmann94', 'Sicart11'


' INITIAL CONDITIONS '
initial_snowheight_constant = 1.0               # Initial snowheight
initial_snow_layer_heights = 0.010               # Initial thickness of snow layers
...
temperature_top_constant = 273.16                # Upper boundary condition for initial temperature profile (K)
...
' MODEL CONSTANTS '
center_snow_transfer_function = 1.2             # center (50/50) when total precipitation is transferred to snow and rain
spread_snow_transfer_function = 1.0               # 1: +-2.5
...
minimum_snow_layer_height = 0.0015               # minimum layer height
...
' PHYSICAL CONSTANTS '
constant_density = 250.                         # constant density of freshly fallen snow [kg m-3], if densification_method is set to 'constant'

albedo_fresh_snow = 0.87                         # albedo of fresh snow [-] (Moelg et al. 2012, TC)
