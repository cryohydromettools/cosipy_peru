...
temperature_bottom = 272.00                      # Lower boundary condition for initial temperature profile (K)
const_init_temp = 0.1                           # constant for init temperature profile used in exponential function (exponential decay)


' MODEL CONSTANTS '
center_snow_transfer_function = 0.5            # center (50/50) when total precipitation is transferred to snow and rain
...
albedo_fresh_snow = 0.91                         # albedo of fresh snow [-] (Moelg et al. 2012, TC)
albedo_firn = 0.59                              # albedo of firn [-] (Moelg et al. 2012, TC)
albedo_ice = 0.3                                # albedo of ice [-] (Moelg et al. 2012, TC)
albedo_mod_snow_aging = 1.0                    # effect of ageing on snow albedo [days] (Moelg et al. 2012, TC)
