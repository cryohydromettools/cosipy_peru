...
var1a    = ds['G']
var1_d  = var1a.resample(freq = 'd', dim = 'time', how = 'mean')
var1_d  = var1_d.values
var2a    = ds['ALBEDO']
var2_d  = var2a.resample(freq = 'd', dim = 'time', how = 'mean')
var2_d  = var2_d.values
var3_d  = var2a.resample(freq = 'd', dim = 'time', how = 'mean')
...
SWnet_m  = select_below(dem_nc,mask_nc,var3_d,5000)
...
LWnet_m  = select_below(dem_nc,mask_nc,var3_d,5000)
...
var1_d  = var1a.resample(freq = 'd', dim = 'time', how = 'mean')
var1_d  = var1_d.values
H_m  = select_below(dem_nc,mask_nc,var1_d,5000)
...
var1_d  = var1a.resample(freq = 'd', dim = 'time', how = 'mean')
var1_d  = var1_d.values
LE_m  = select_below(dem_nc,mask_nc,var1_d,5000)
...
var1_d  = var1a.resample(freq = 'd', dim = 'time', how = 'mean')
var1_d  = var1_d.values
B_m  = select_below(dem_nc,mask_nc,var1_d,5000)
...
var1_d  = var1a.resample(freq = 'd', dim = 'time', how = 'mean')
var1_d  = var1_d.values
ME_m  = select_below(dem_nc,mask_nc,var1_d,5000)
