...
ME_all  = ds['ME']
ME_day  = ME_all.resample(freq = 'd', dim = 'time', how = 'mean')
ME_m    = ME_day.resample(freq = 'm', dim = 'time', how = 'mean')
ME_all  = np.mean(ME_m.values,axis=0)

fig, ax = plt.subplots(figsize=(4,5))
im = ax.contourf(lon_nc,lat_nc,ME_all,20,vmin=0, vmax=110, cmap='jet')
